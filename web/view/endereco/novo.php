    ...
    <div class ="container">
        <div class ="justify-content-center align-itens-center row">
            <div class = "col-6" >
                ...
                <form class="formLogin" action='<?php echo Go::ContaController('endereco/novo'); ?>' method="POST">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Inserir" class="form-control" style="background-color: rgb(22, 16, 16); color:snow;"><br>
                        </div>   
